      ...
      <div className="max-w-3xl mx-auto px-6 py-12">
        ...
        <div>
          <div className="flex items-center justify-between mb-6">
            ...
            <button className="bg-white text-black text-sm font-semibold px-4 py-2 rounded-xl hover:bg-white/90 transition">
              + Add activity
            </button>
          </div>
          ...
          <div className="border border-dashed border-white/10 rounded-2xl p-16 text-center">
            ...
            <button className="bg-white text-black text-sm font-semibold px-6 py-3 rounded-xl hover:bg-white/90 transition">
